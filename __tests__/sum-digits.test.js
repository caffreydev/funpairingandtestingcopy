...
describe('tests for sum-digits', () => {
  test('one digit number should be returned unchanged', () => {
    expect(sumDigits(1)).toBe(1);
  });
  test('2 digit number should give correct sum', () => {
    expect(sumDigits(23)).toBe(5);
  });
  test('8 digit number should give correct sum', () => {
    expect(sumDigits(30050021)).toBe(11);
  });
});
